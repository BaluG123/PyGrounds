...
export const aiProjectsCourse: CourseModule = {
  ...
  quiz: [
    { id: 'aip-q1', prompt: 'Which step typically takes the most time in an ML project?', options: ["Choosing the algorithm", "Data preparation and cleaning", "Training the model", "Deploying to production"], answerIndex: 1, explanation: 'Data cleaning and feature engineering consume roughly 80% of project time.' },
    { id: 'aip-q2', prompt: 'What is overfitting?', options: ["Model is too simple to learn patterns", "Model takes too long to train", "Model memorizes training data but fails on new data", "Model uses too much memory"], answerIndex: 2, explanation: 'Overfitting means high training accuracy but poor generalization.' },
    { id: 'aip-q3', prompt: 'How do you fix underfitting?', options: ["Remove training data", "Reduce the learning rate to zero", "Use fewer epochs", "Use a more complex model or add features"], answerIndex: 3, explanation: 'Underfitting means the model cannot capture the underlying pattern.' },
    ...
    { id: 'aip-q5', prompt: 'Why is explainability important in AI?', options: ["It makes models run faster", "Users and regulators need to understand why decisions are made", "It reduces code size", "It replaces the need for testing"], answerIndex: 1, explanation: 'In healthcare, finance, and law, unexplainable AI decisions are unacceptable.' },
    { id: 'aip-q6', prompt: 'What is AI bias?', options: ["A type of activation function", "The bias term in y = wx + b", "Systematic unfairness due to skewed training data", "A testing framework"], answerIndex: 2, explanation: 'Bias in ML often refers to societal biases embedded in historical data.' },
    { id: 'aip-q7', prompt: 'L2 regularization helps prevent:', options: ["Underfitting", "Slow training", "Data leakage", "Overfitting by penalizing large weights"], answerIndex: 3, explanation: 'L2 adds a penalty proportional to the sum of squared weights, discouraging complexity.' },
    ...
    { id: 'aip-q9', prompt: 'What does "version your data" mean?', options: ["Convert data to the latest Python version", "Track changes to datasets over time", "Use the newest data format", "Delete old data"], answerIndex: 1, explanation: 'Data versioning ensures reproducibility and tracks how data changes affect model performance.' },
    { id: 'aip-q10', prompt: 'Feature engineering is:', options: ["Removing all features", "A type of neural network layer", "Creating new input variables from raw data to improve model performance", "The same as hyperparameter tuning"], answerIndex: 2, explanation: 'Good features often have more impact than choosing a fancier algorithm.' },
  ],
  practice: [
