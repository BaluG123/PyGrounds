...
export const matplotlibCourse: CourseModule = {
  ...
  quiz: [
    { id: 'mpl-q1', prompt: 'Who created Matplotlib?', options: ["Wes McKinney", "John D. Hunter", "Guido van Rossum", "Yann LeCun"], answerIndex: 1, explanation: 'John D. Hunter created Matplotlib in 2003.' },
    { id: 'mpl-q2', prompt: 'What is an axes object?', options: ["Only the x-axis line", "A CSV reader", "The plotting area inside a figure", "A NumPy dtype"], answerIndex: 2, explanation: 'Axes contain plotted data, ticks, labels, and scales.' },
    { id: 'mpl-q3', prompt: 'Which chart is best for a distribution?', options: ["Single number", "Package list", "Import statement", "Histogram"], answerIndex: 3, explanation: 'Histograms show how values are distributed across bins.' },
    ...
    { id: 'mpl-q5', prompt: 'What does plt.subplots(2, 3) create?', options: ["A single large plot", "A figure with 6 axes in a 2×3 grid", "23 separate figures", "An error"], answerIndex: 1, explanation: 'subplots(rows, cols) creates a grid of individual plotting areas.' },
    { id: 'mpl-q6', prompt: 'Which plot type is best for showing correlation between features?', options: ["Pie chart", "Bar chart", "Scatter plot", "Line chart"], answerIndex: 2, explanation: 'Scatter plots reveal the relationship pattern between two continuous variables.' },
    { id: 'mpl-q7', prompt: 'What does plt.tight_layout() do?', options: ["Makes the figure smaller", "Removes gridlines", "Changes the colormap", "Adjusts spacing to prevent overlapping labels"], answerIndex: 3, explanation: 'tight_layout() automatically adjusts subplot parameters for clean spacing.' },
    ...
    { id: 'mpl-q9', prompt: 'If validation loss increases while training loss decreases, what is happening?', options: ["Underfitting", "Overfitting", "Perfect generalization", "Data leakage"], answerIndex: 1, explanation: 'This divergence pattern is the classic sign of overfitting.' },
    { id: 'mpl-q10', prompt: 'What does the cmap parameter control?', options: ["The camera angle", "The chart margins", "The color scheme of the plot", "The file format"], answerIndex: 2, explanation: 'cmap (colormap) sets the color palette used to represent values.' },
  ],
  practice: [
