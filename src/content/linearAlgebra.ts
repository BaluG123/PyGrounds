...
export const linearAlgebraCourse: CourseModule = {
  ...
  quiz: [
    { id: 'la-q1', prompt: 'What does the dot product measure?', options: ["Distance between vectors", "Alignment / similarity between vectors", "The angle in degrees", "The number of elements"], answerIndex: 1, explanation: 'The dot product measures how much two vectors point in the same direction.' },
    { id: 'la-q2', prompt: 'If A is (3×2) and B is (2×4), what is the shape of A @ B?', options: ["(2, 2)", "(3, 2)", "(3, 4)", "Cannot multiply"], answerIndex: 2, explanation: 'Inner dims (2) match. Result shape is (outer dims) = (3, 4).' },
    { id: 'la-q3', prompt: 'What is the transpose of a (3×2) matrix?', options: ["(3, 2)", "(3, 3)", "(2, 2)", "(2, 3)"], answerIndex: 3, explanation: 'Transpose flips rows and columns: (m,n) → (n,m).' },
    ...
    { id: 'la-q5', prompt: 'What does PCA use eigenvectors for?', options: ["Encrypting data", "Finding directions of maximum variance", "Sorting arrays", "Counting rows"], answerIndex: 1, explanation: 'PCA projects data onto eigenvectors of the covariance matrix with the largest eigenvalues.' },
    { id: 'la-q6', prompt: 'What does SVD stand for?', options: ["Standard Vector Derivation", "Simple Variable Distribution", "Singular Value Decomposition", "Structured Value Detection"], answerIndex: 2, explanation: 'SVD decomposes any matrix into U × Σ × Vᵀ.' },
    { id: 'la-q7', prompt: 'A singular matrix has determinant equal to:', options: ["1", "-1", "Infinity", "0"], answerIndex: 3, explanation: 'Determinant = 0 means the matrix has no inverse (is singular).' },
    { id: 'la-q8', prompt: 'What is the L2 norm of vector [3, 4]?', options: ['5', '7', '12', '25'], answerIndex: 0, explanation: '||[3,4]|| = √(9+16) = √25 = 5.' },
    { id: 'la-q9', prompt: 'Orthogonal vectors have a dot product of:', options: ["1", "0", "-1", "Infinity"], answerIndex: 1, explanation: 'Perpendicular (orthogonal) vectors have zero dot product.' },
    { id: 'la-q10', prompt: 'In a neural network layer, Y = X @ W + b. What is W?', options: ["Input data", "Output", "Weight matrix", "Bias vector"], answerIndex: 2, explanation: 'W contains the learned weights that transform the input X.' },
  ],
  practice: [
